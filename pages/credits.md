...
* [Thomas Miller](mailto:tmiller26@mail.usf.edu)
    * My role in the project will be the Digital Scholar. I will be responsible for the sources we research on our project and ensure they are from credible accounts. I will record a step by step process by writing a "digital methods and historic scholarship" page. I will plan on using the sources to inform the other members on how best to look at them for intended data that will be useful for the project. From the data I will look for data files and any other useful materials that I can send to my team for visuals and noticing trends for our project.
* Faris Chaoui
